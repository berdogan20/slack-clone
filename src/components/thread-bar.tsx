...
export const ThreadBar = ({
    ...
    return (
        <button
            onClick={onClick}
            className="p-1 roundeed-md hover:bg-white border border-transparent hover:border-border flex items-center justify-start group/thread-bar transition max-w-[600px]"
        >
